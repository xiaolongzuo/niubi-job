 ...
 * @since 16/1/9 14:43
 */
public class MasterSlaveNodeBackup extends AbstractRemoteJobNode {
    ...
    public MasterSlaveNodeBackup(String zookeeperAddresses, String jarRepertoryUrl, String[] propertiesFileNames) {
