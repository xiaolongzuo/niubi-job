...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="/standbyJobSummaries" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Job runtime manager</a></div>
    </div>
            ...
            <div class="span9">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/standbyJobSummaries/update" method="POST" class="form-horizontal" enctype="multipart/form-data">
